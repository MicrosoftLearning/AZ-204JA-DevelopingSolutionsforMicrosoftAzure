...
1.  **raster-graphics** コンテナーで、「**アップロード**」 を選択して **graph.jpg** ファイルをラボ VM の **Allfiles (F): \\Allfiles\\Labs\\03\\Starter\\Images** フォルダーにアップロードします。
...
1.  ターミナルを使用して、コンソール アプリケーション プロジェクトを実行します。
...
1.  **vector-graphics** コンテナーで、「**アップロード**」 を選択 して に **graph.svg** ファイルをアップロードします。**Allfiles (F): \\Allfiles\\Labs\\03\\Starter\\Images** フォルダーにアップロードします。
